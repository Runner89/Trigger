...
def place_increase_order_trigger(api_key, secret_key, symbol, quantity, trigger_price, position_side="LONG"):
    
    #Platzierung einer Trigger-Order zum Vergrößern der Position.
    #trigger_price: Preis, ab dem die Order ausgelöst wird
    ...
    params_dict = {
        ...
        "side": "BUY",
        "type": "STOP_MARKET",
        "stopPrice": round(trigger_price, 6),
        "quantity": round(quantity, 6),
        "positionSide": position_side,
        "timestamp": timestamp,
        "timeInForce": "GTC"
